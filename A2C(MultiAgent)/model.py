...
class Critic(nn.Module):
    ...
    def __init__(self, state_space_size, state_mid_dim=60, init_weight=True):
        super(Critic, self).__init__()
        self.state_space_size = state_space_size
        self.linear_1 = nn.Linear(state_space_size, state_mid_dim)
        self.activation_1 = F.relu
        self.linear_2 = nn.Linear(state_mid_dim, 1)
    ...
    def forward(self, state):
        ...
        :return:
        """
        logits = self.linear_2(self.activation_1(self.linear_1(state)))
        return logits
